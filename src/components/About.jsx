          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative z-10 h-full bg-gradient-to-br from-primary/90 to-secondary/90 p-8 text-white">
                ...
                >
                  To be the leading association championing excellence,
                  inclusivity, and innovation in student affairs for the
                  holistic development of students in Kenyan universities.
                </motion.p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 h-full bg-gradient-to-bl from-secondary/90 to-primary/90 p-8 text-white">
                ...
                <motion.p
                  ...
                  className="text-lg leading-relaxed"
                >
                  To promote the welfare and success of students in higher
                  education by providing professional support to Deans of
                  Students, fostering collaboration among universities, and
                  advocating for policies that enhance the student experience.
                </motion.p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="mt-16">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {[
                {
                  title: "Excellence",
                  desc: "A commitment to professional engagement in practice and scholarship",
                },
                { title: "Integrity", desc: "A commitment to professional ethics" },
                { title: "Service", desc: "A commitment to work that promotes justice" },
                {
                  title: "Inclusion",
                  desc: "A commitment to supporting diverse leadership and participation",
                },
                {
                  title: "Leadership",
                  desc: "A commitment to values-based leading and learning",
                },
